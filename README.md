# Фреймворк взаимодействия с API платформы Visiology3
...
- Файл **schedules_info.py**  
    Содержит скрипт, реализующий выгрузку сводной информации о настроенных планировщиках загрузки в файл CSV.
